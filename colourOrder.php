 ...
 */
    ...
    if (isset($_POST['orderSubmit'])) {
        ...
        $sql1 = "SELECT * FROM 4colourdp_format WHERE paper_type='$paper' AND size='$size' AND side='$side' ";
        ...
        function GetImageExtension($imagetype)
        {
            ...
            switch($imagetype)
            {
                case '4colourOrders/bmp': return '.bmp';
                case '4colourOrders/gif': return '.gif';
                case '4colourOrders/jpeg': return '.jpg';
                case '4colourOrders/png': return '.png';
        ...
        if (!empty($_FILES["uploadedImage"]["name"])) {
            ...
            $target_path = "4colourOrders/".$imagename;

            if(move_uploaded_file($temp_name, $target_path)) {
                $query_upload="INSERT into 4colour_order (uEmail,uName,paper_type,size,side,imagePath,submissionDate,qty,price) VALUES
