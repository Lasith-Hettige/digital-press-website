    ...
    <div class="container">
        <div class="row">
            ...
            <div class="title text-center wow fadeIn" data-wow-duration="500ms">
                <h2>Black &amp; White  <span class="color">Printing</span></h2>
                <?php include "blackOrder.php"; ?>
            ...
            <div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                <form id="black_order_form" method="post" action="blackPrinting.php#services" role="form" enctype="multipart/form-data">
