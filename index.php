    ...
    <header id="navigation" class="navbar navigation">
        ...
        <nav class="collapse navbar-collapse navbar-right" role="Navigation">
            <ul id="nav" class="nav navbar-nav navigation-menu">
                ...
                <li><a data-scroll href="#our-team">Login</a></li>
                <li><a data-scroll href="#pricing">Register</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				<h2 style="color: white">Great Design & Incredible Features</h2>
				<p style="color:gainsboro">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis tenetur odio impedit incidunt? <br> Omnis accusantium ea reiciendis, fugit commodi nostrum.</p>
		...
		<div class="row">
			...
			<article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms">
				<div class="service-block text-center">
					...
					<h3>4 Colour Digital Printing</h3>
					...
					<div class="row portfolio-items-wrapper">
						<div class="mix col-md-4 design">
							<div class="portfolio-block">
								<img class="img-responsive" src="images/portfoli/portfolio-1.jpg" alt="">
								<div class="caption">

									<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfolio-1.jpg" data-lightbox="image-1">
						...
						<div class="mix col-md-4 design">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfoli-2.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfoli-2.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
										<h4><a href="">Colour Printing</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
									</div>
								</div>
						</div>
						<div class="mix col-md-4 design development">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfoli-3.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfoli-3.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
										<h4><a href="">Magazine Design</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
									</div>
								</div>
						</div>
						<div class="mix col-md-4 photography development">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfolio-4.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfolio-4.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
						...
						<div class="mix col-md-4 design">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfolio-5.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfolio-5.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
						...
						<div class="mix col-md-4 photography" >
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfolio-6.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfolio-6.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
										<h4><a href="">Tag Design</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
						...
						<div class="mix col-md-4 design">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfolio-7.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfolio-7.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
						...
						<div class="mix col-md-4 design">
							<div class="portfolio-block">
									<img class="img-responsive" src="images/portfoli/portfoli-8.jpg" alt="">
									<div class="caption">
										<a class="search-icon image-popup" data-effect="mfp-with-zoom" href="images/portfoli/portfoli-8.jpg" data-lightbox="image-1">
											<i class="tf-ion-android-search"></i>
										</a>
										<h4><a href="">Black & White Printing</a></h4>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, nemo!</p>
									</div>
								</div>
						</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
				...
				<form id="login-form" method="post" action="login_user.php" role="form">
					<?php
					...
					<div class="form-group">
						<input type="email" placeholder="Your Email" class="form-control" name="email" id="form_email" ><span class="label label-warning" id="email1_error_message"></span>
					</div>
			...
			<div class="container">
				<div class="row">
				    ...
				    <div class="title text-center wow fadeInDown" data-wow-duration="500ms">
			        	<h2>User <span class="color">Registration</span></h2>
				        <div class="border"></div>

						<?php include "reg_user.php"; ?>
				    </div>
				    <!-- /section title -->
					...
					<!-- Registration Form -->
					<div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
						<form id="registration_form" method="post" action="index.php#pricing" role="form">

							<div class="form-group">
								<input type="fname" placeholder="First Name" class="form-control" name="fname" id="form_username" ><span class="label label-warning" id="username_error_message"></span>
							</div>

							<div class="form-group">
								<input type="lname" placeholder="Last Name" class="form-control" name="lname" id="form_lname"><span class="label label-warning" id="lname_error_message"></span>
							</div>

							<div class="form-group">
								<input type="cname" placeholder="Company Name" class="form-control" name="cname" id="form_cname"><span class="label label-warning" id="cname_error_message"></span>
							</div>

							<div class="form-group">
								<input type="cnumber" placeholder="Contact Number" class="form-control" name="cnumber" id="form_cnumber"><span class="label label-warning" id="cnumber_error_message"></span>
							</div>

							<div class="form-group">
								<input type="email" placeholder="Email" class="form-control" name="email" id="form_email" ><span class="label label-warning" id="email_error_message"></span>
							</div>

							<div class="form-group">
								<input type="password" placeholder="Password" class="form-control" name="password_1" id="form_password" ><span class="label label-warning" id="password_error_message"></span>
							</div>

							<div class="form-group">
								<input type="password" placeholder="Password" class="form-control" name="password_2" id="form_retype_password"><span class="label label-warning" id="retype_password_error_message"></span>
							</div>


							<div id="cf-submit">
								<button type="submit" name="reg_user" class="btn btn-info btn-lg btn-block">Submit</button>
							</div>
...
<section id="contact-us" class="contact-us section-bg">
	<div class="container">
		...
		<script type="text/javascript" language="JavaScript" src="reg_user_validation.js"></script>
