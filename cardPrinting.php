...
<section class="call-to-action section-sm overly">
    <img src="./images/backgrounds/bCard.jpg" height="400" width="1320" >
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="title text-center wow fadeIn" data-wow-duration="500ms">
                <h2>Business Card  <span class="color">Printing</span></h2>
                <?php include "cardOrder.php"; ?>
            ...
            <div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                <form id="card_order_form" method="post" action="cardPrinting.php#services" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <select name="size" id="form_size" class="form-control">
                            ...
                            <option value="90X50mm">90 X 50mm</option>
                    ...
                    <div class="form-group">
                        <select name="paperType" id="form_paperType" class="form-control">
                            ...
                            <?php
                            $sql = "SELECT * FROM card_paper_type ";
