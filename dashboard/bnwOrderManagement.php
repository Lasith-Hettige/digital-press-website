...
<section id="userManagement" class="bg-one section">
    <div class="container">
        ...
        <h2 style="color:white;">Black & White Oder Management</h2><br>
                ...
                success:function(data){
                    ...
                    $.each(data, function(i, v) {
                        raws += "<tr  style='color:#57cbcc'>"+
                            ...
                            "<td>"+ v.side  +"</td>" +
                            "<td>"+ v.imagePath  +"</td>" +
                            "<td>"+ v.submitionDate  +"</td>" +
                            "<td>"+ v.qty  +"</td>" +
                            "<td>"+ v.price  +"</td>" +
                            "<td><button type=\"button\" value=\"Delete\" name=\"delete\"  data-user-id="+ v.oId +" class=\"delete_data btn btn-danger btn-xs \">Delete</button></td>" +
                            "</tr>";
                    });
                    raws += "</tbody>";
