...
<section id="userManagement" class="bg-one section">
    <div class="container">
        ...
        <h2 style="color:white;">Login Management</h2>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="insert_form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="user_password" id="user_password" placeholder="">
                        </div>
                        <div class="form-group">
                ...
                success:function(data){
                    ...
                    $.each(data, function(i, v) {
                        raws += "<tr  style='color:#57cbcc'>"+
                            ...
                            "<td>"+ v.password +"</td>" +
                            "<td>"+ v.status +"</td>" +
                            "<td><button type=\"button\" value=\"Edit\" name=\"edit\" data-user-id="+ v.Lid +" class=\"edit_data btn btn-info btn-xs \">Edit</button> <button type=\"button\" value=\"Delete\" name=\"delete\"  data-user-id="+ v.Lid +" class=\"delete_data btn btn-danger btn-xs \">Delete</button></td>" +
                            "</tr>";
                    });
                    raws += "</tbody>";
